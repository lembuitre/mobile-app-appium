...
${ELEMENT_LOGIN_EMAIL_IOS}=       xpath=//XCUIElementTypeTextField[@name="Email"]
${ELEMENT_LOGIN_PASSWORD_IOS}=        accessibility_id=Password
${ELEMENT_LOGIN_BUTTON_ANDROID}=    xpath=//android.widget.Button[@content-desc="Login"]
${ELEMENT_LOGIN_BUTTON_IOS}=    xpath=//XCUIElementTypeButton[@name="Login"]
